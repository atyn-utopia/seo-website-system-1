/**
 * The site's small icon set: one stroke family for the USP bar and the spec
 * list, plus the two third-party marks (WhatsApp, Google) and the review
 * stars. Shared by the homepage and the location pages.
 */
